...
Scalar end2endWrapper(pinocchio::ModelTpl<Scalar> model, pinocchio::DataTpl<Scalar> data, Eigen::Matrix<Scalar, Eigen::Dynamic, 1>& config, int frameInd1, int frameInd2)
{
    ...
    return segmentSegmentDistance_scalar<Scalar>(caps0Pos0[0], caps0Pos0[1], caps0Pos0[2],
...
ADFun tapeADFunEnd2End(pinocchio::Model model, int frameInd1, int frameInd2)
{
    ...
    ADScalar a = end2endWrapper<ADScalar>(cast_rmodel, cast_rdata, ad_X, frameInd1, frameInd2);
    ad_Y[0] = a;
