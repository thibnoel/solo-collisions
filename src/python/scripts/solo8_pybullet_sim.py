...
if enable_viewer:
    viewer_coll = viewerClient(6, 0, thresh_legs, 0, urdf="/home/tnoel/stage/solo-collisions/urdf/solo8_simplified.urdf", modelPath="/home/tnoel/stage/solo-collisions/urdf")
