...
void solo_autocollision_legs_5pairs(const float x[], float y[]) {
   ...
   v[28] = cosf(x[6]);
   v[32] = v[28] * v[32];
   v[30] = v[0] * v[29] + v[6] * v[22] + v[5] * v[32];
   v[28] = 0.0875 + 0.014 * v[28];
   v[27] = 0.014 * v[27];
   v[5] = 0.1946 * (0 - v[0]) + (0 - v[6]) * v[15] + (0 - v[5]) * v[16] + -0.1946 * v[0] + v[6] * v[28] + v[5] * v[27];
   v[6] = 0.1 * v[30] + v[5];
   v[0] = 0 - v[6];
   v[6] = -0.1 * v[30] + v[5] - v[6];
   v[5] = v[11] * v[22] + v[2] * v[32];
   v[11] = (0 - v[11]) * v[15] + (0 - v[2]) * v[16] + v[11] * v[28] + v[2] * v[27];
   v[2] = 0.1 * v[5] + v[11];
   v[11] = -0.1 * v[5] + v[11] - v[2];
   v[32] = v[4] * v[29] + v[3] * v[22] + v[19] * v[32];
   v[27] = 0.1946 * (0 - v[4]) + (0 - v[3]) * v[15] + (0 - v[19]) * v[16] + -0.1946 * v[4] + v[3] * v[28] + v[19] * v[27];
   v[28] = 0.1 * v[32] + v[27];
   v[27] = -0.1 * v[32] + v[27] - v[28];
   v[32] = v[6] * v[6] + v[11] * v[11] + v[27] * v[27];
   v[19] = -0.2 * v[27];
   v[3] = 0.04 * v[32] - v[19] * v[19];
   v[2] = 0 - v[2];
   v[28] = 0.1 - v[28];
   v[16] = v[6] * v[0] + v[11] * v[2] + v[27] * v[28];
   v[15] = -0.2 * v[28];
   if( v[3] < 1e-09 ) {
      v[4] = 0;
   } else {
   ...
   v[0] = v[28] + -0.2 * v[0] - v[16] * v[27];
   y[4] = sqrt(v[6] * v[6] + v[2] * v[2] + v[0] * v[0]) - 0.032;
}
