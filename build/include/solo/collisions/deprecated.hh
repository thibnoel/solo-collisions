...
#ifndef SOLO_COLLISIONS_DEPRECATED_HH
# define SOLO_COLLISIONS_DEPRECATED_HH
...
//  void foo () SOLO_COLLISIONS_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar SOLO_COLLISIONS_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a SOLO_COLLISIONS_DEPRECATED = 0;
//
...
#  define SOLO_COLLISIONS_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define SOLO_COLLISIONS_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define SOLO_COLLISIONS_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! SOLO_COLLISIONS_DEPRECATED_HH
