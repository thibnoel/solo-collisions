...
CMakeFiles/release:
	export LD_LIBRARY_PATH=/opt/openrobots/lib: && export LD_LIBRARY_PATH=/opt/openrobots/lib: && export PYTHONPATH=/opt/openrobots/lib/python3.6/site-packages: && ! test x$$VERSION = x || ( echo Please\ set\ a\ version\ for\ this\ release && false ) && cd /home/tnoel/stage/solo-collisions && /usr/bin/git tag -s v$$VERSION -m Release\ of\ version\ $$VERSION. && cd /home/tnoel/stage/solo-collisions/build && cmake /home/tnoel/stage/solo-collisions && make distcheck || ( echo Please\ fix\ distcheck\ first. && cd /home/tnoel/stage/solo-collisions && /usr/bin/git tag -d v$$VERSION && cd /home/tnoel/stage/solo-collisions/build && cmake /home/tnoel/stage/solo-collisions && false ) && make dist && make distclean && echo Please,\ run\ 'git\ push\ --tags'\ and\ upload\ the\ tarball\ to\ github\ to\ finalize\ this\ release.
