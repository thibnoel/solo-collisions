...
IF(NOT EXISTS "/home/tnoel/stage/solo-collisions/build/install_manifest.txt")
  MESSAGE(FATAL_ERROR "Cannot find install manifest:\"/home/tnoel/stage/solo-collisions/build/install_manifest.txt\"")
ENDIF(NOT EXISTS "/home/tnoel/stage/solo-collisions/build/install_manifest.txt")
...
FILE(READ "/home/tnoel/stage/solo-collisions/build/install_manifest.txt" files)
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND "/usr/bin/cmake" -E remove "/home/tnoel/stage/solo-collisions/build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
